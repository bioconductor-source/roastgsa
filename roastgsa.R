...
roastgsa <- function(y, covar, form, contrast = NA, design = NULL,
                     self.contained = FALSE, set.statistic = "maxmean",
                     psel = NULL, index = NULL, nrot = 9999, minsize = 10, maxsize = 500,  mccores = 1,
    ...
    # Index
    if(is.null(index)){
       index.o <- indexFunction(y2, gsetsel, gspath = gspath, minsize = minsize, maxsize = maxsize,
                                geneRandom = FALSE, forPRgsea = TRUE)

       index <- indexFunction(y2, gsetsel, gspath = gspath, minsize = minsize, maxsize = maxsize,
    ...
    # froastgsa function
    res <- froastgsa(y = y, index = index, design = design, contrast = contrast, set.statistic = set.statistic,
                     nrot = nrot, mccores = mccores, psel = psel, executation.info = executation.info,
